...
<li><strong>Instrument Selection: </strong>A Streamlit Web App is designed to allow the user to interact with this Music System. The user selects an instrument using a dropdown. The Web App displays the image of the selected instrument and plays a video generated using Synthesia.io wherein an AI Avatar describes the chosen instrument.</li>
